...
describe('test suite: Product class', () => {
  ...
  it('getStarsUrl returns the correct url', () => {
    const product = new Product(productDetails);
    expect(product.getStarsUrl()).toEqual('images/ratings/rating-45.png');
  });

  it('getPrice returns the correct price', () => {
    const product = new Product(productDetails);
...
describe('test suite: Clothing class', () => {
  ...
  it('creates a clothing product with correct properties', () => {
  ...
  it('extraInfoHTML contains the size chart link', () => {
    const clothing = new Clothing(clothingDetails);
...
describe('test suite: Appliance class', () => {
  ...
  it('creates an appliance with correct properties', () => {
  ...
  it('extraInfoHTML contains the instructions link', () => {
    const appliance = new Appliance(applianceDetails);
  ...
  it('extraInfoHTML contains the warranty link', () => {
    const appliance = new Appliance(applianceDetails);
